...
export const PACKAGES_DATA: PackagesData = {
  ...
  terms: [
    { icon: '💳', text: 'نظام الدفع: يختلف حسب الباقة المختارة (يرجى الاطلاع على الشروط المرفقة مع كل باقة في ملف الـ PDF).' },
    { icon: '🔄', text: 'سياسة التعديلات: يحق للعميل عدد معين من جولات التعديل حسب نوع الباقة المتفق عليها.' },
    { icon: '🚫', text: 'سياسة الإلغاء: العربون أو المبالغ المدفوعة مقدماً غير مستردة في حال قرر العميل إلغاء المشروع بعد البدء.' },
    { icon: '📁', text: 'الملفات المستلمة: يتم تسليم الأعمال بالصيغ الاحترافية المحددة مسبقاً في تفاصيل باقتك.' },
  ],
  dynamicTerms: {
    logo_lite: [
